...
UID ?= $(shell id -u)
GID ?= $(shell id -g)
WINDOCKERIMAGE := $(BINARY)-win64-cross-go1.23-qt5.15-static:latest
OSXINTELDOCKER := $(BINARY)-macos-cross-x86_64-sdk13.1-go1.24.3-qt5.15-dynamic:latest
OSXARMDOCKER := $(BINARY)-macos-cross-arm64-sdk13.1-go1.24.3-qt5.15-dynamic:latest
LINUX64DOCKER := $(BINARY)-linux64-go1.24-qt5.15-dynamic:latest
OS := $(shell uname -s)
